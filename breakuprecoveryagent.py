#AI AGENTS SERIES 
#2ND AI AGENT: BREAKUP RECOVERY AGENT 
...
def initialize_agents(api_key: str) -> tuple[Agent, Agent, Agent, Agent]:
    try:
        ...
        routine_planner_agent = Agent(
            ...
            instructions = [
                "You are recovery routine planner that:",
...
with st.sidebar:
    ...
    if api_key:
        ...
        st.markdown("""
                    ...
                    2. Enable the Generative Language API in your [Google Cloud Console](https://console.developers.googleapis.com)
                    """)
...
with col2:
    ...
    if uploaded_files:
        for file in uploaded_files:
            st.image(file, caption=file.name, user_container_width = True)
                    ...
                    with st.spinner("Crafting closure messages...."):
                        ...
                        Include:
                            ...
                            Include:
                                ...
                                st.subheader("Honest Perspectives")
                                st.markdown(response.content)
